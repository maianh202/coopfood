              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Quản trị đơn hàng <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a <?php  if($soluong1 !=0) {?> href="danhsachdonhang.php?id=<?php echo $row1["trangthaiid"];} else 	 {echo '<script type="text/javascript">
			alert("Không có đơn hàng nào");
			window.location.href="danhsachdonhang.php";
		</script>';}?>">Đang xử lý(<?php echo $soluong1 ;?>)</a></li>
