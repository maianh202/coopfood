...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2023 at 06:56 PM
...
(1, 23, 17910, 1, 17910),
(1, 28, 225000, 1, 225000),
(2, 82, 437850, 1, 437850),
(3, 51, 60480, 1, 60480),
(3, 53, 348300, 1, 348300),
(4, 12, 338310, 1, 338310),
(5, 31, 48510, 1, 48510),
(5, 32, 89550, 1, 89550),
(6, 41, 19260, 5, 96300),
(7, 62, 337050, 1, 337050),
(8, 2, 153540, 1, 153540),
(9, 93, 201600, 1, 201600);
...
CREATE TABLE `chitietyeucau` (
  ...
  `hinhanhyeucau` longblob DEFAULT NULL,
  `hinhanhContent` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `chitietyeucau` (`yeucauid`, `sanphamid`, `soluongyc`, `hinhanhyeucau`, `hinhanhContent`) VALUES
(1, 14, 1, NULL, '');
...
(1, 9, NULL, '2023-06-11 23:44:48', NULL, 242910, '', 1, '0976233589', 'Hà Nội', 'Phú Xuyên', 'Nam Tiến', 'thôn Văn Nhân'),
(2, 3, NULL, '2023-06-11 23:45:30', NULL, 437850, '', 1, '0983032776', 'Hà Nội', 'Phú Xuyên', 'Hồng Minh', 'số 13 '),
(3, 4, NULL, '2023-06-11 23:46:27', NULL, 408780, '', 1, '0987678654', 'Hà Nội', 'Hà Đông', 'Nguyễn Trãi', 'số 194 Nguyễn Trãi'),
(4, 7, NULL, '2023-06-11 23:47:54', NULL, 338310, '', 1, '0913245141', 'Hà Nội', 'Thanh Xuân', 'Kim Giang', 'ngõ 250 Kim Giang'),
(5, 5, NULL, '2023-06-11 23:48:44', NULL, 158060, '', 1, '0975674725', 'Hà Nội', 'Nam Từ Liêm', 'Mỹ Đình', 'ngõ số 4 đường Hàm Nghi'),
(6, 1, NULL, '2023-06-11 23:50:22', NULL, 116300, '', 1, '0378588031', 'Hà Nội', 'Thanh Xuân', 'Kim Giang', 'đường Bùi Xương Trạch'),
(7, 6, NULL, '2023-06-11 23:51:39', NULL, 337050, '', 1, '0976233589', 'Hà Nội', 'Nam Từ Liêm', 'Mỹ Đình 2', 'ngõ số 4 đường Hàm Nghi'),
(8, 8, NULL, '2023-06-11 23:52:58', NULL, 173540, '', 1, '0176232446', 'Hà Nội', 'Phú Xuyên', 'Phú Túc', 'thôn Hoàng Xá'),
(9, 2, NULL, '2023-06-11 23:54:27', NULL, 201600, '', 1, '0375855222', 'Hà Nội', 'Hà Đông', 'Nguyễn Trãi', 'số 108 Nguyễn Trãi');
...
(1, 'mai anh', 'maianh202@gmail.com', 'maianh', '0000-00-00', '0375855222', 'Bùi Xương Trạch - Hà Nội', 'Nữ'),
(2, 'Hằng', 'hang@gmail.com', 'hang2000', '0000-00-00', '0913423564', 'Khương Đình - Thanh Xuân - Hà Nội', 'Nữ'),
(3, 'Phạm Hoàng', 'pvhoang1804@gmail.com', 'hoang202', '0000-00-00', '0983032776', 'Phú Xuyên - Hà Nội', 'Nam'),
(4, 'Ngô Huy', 'huyyy1999@gmail.com', 'huyngo', '0000-00-00', '0975763889', 'Hà Đông - Hà Nội', 'Nữ'),
(5, 'Thanh Mai', 'tmai1988@gmail.com', 'mai1988', '0000-00-00', '0975674725', 'Mỹ Đình - Hà Nội', 'Nữ'),
(6, 'Mai Phương', 'maiphuong123@gmail.com', 'phuong1993', '0000-00-00', '0965523725', 'Mỹ Đình - Hà Nội', 'Nữ'),
(7, 'Linh', 'lingling@gmail.com', 'ling123', '0000-00-00', '0913245141', 'Thanh Xuân - Hà Nội', 'Nam'),
(8, 'Lê Đức', 'leduc092002@gmail.com', 'duc2002', '0000-00-00', '0176232446', 'Phú Xuyên - Hà Nội', 'Nam'),
(9, 'Chí Hiếu', 'hieuoi@gmail.com', 'hieuhieu', '0000-00-00', '0976788231', 'Phú Xuyên - Hà Nội', '');
...
(2, 'Táo Envy Mỹ nhỏ kg', 1, 15, 2999, 170600, 'Kg', 153540, 'images/sp/2.png', 'images/sp/2-big.png', NULL),
...
(11, 'Ức gà không xương kg – TD', 2, 15, 2999, 95900, 'Kg', 86310, 'images/sp/11.png', 'images/sp/11-big.png', NULL),
(12, 'Bắp bò kg', 2, 15, 2999, 375900, 'Kg', 338310, 'images/sp/12.png', 'images/sp/12-big.png', NULL),
...
(23, 'Bún tươi – kg', 3, 15, 2999, 19900, 'Kg', 17910, 'images/sp/23.png', 'images/sp/23-big.png', NULL),
(24, 'Mực rim me Đầm Sen hộp 150g', 3, 14, 2999, 71200, 'Hộp', 64080, 'images/sp/24.png', 'images/sp/24-big.png', NULL),
(25, 'Cá cơm tẩm me ăn liền Đầm Sen hủ 200g', 3, 14, 2999, 84000, 'Hộp', 75600, 'images/sp/25.png', 'images/sp/25-big.png', NULL),
...
(28, 'Thịt kho tàu kg', 3, 15, 2999, 250000, 'Kg', 225000, 'images/sp/28.png', 'images/sp/28-big.png', NULL),
...
(41, 'Bánh gạo Orion khoai tây phô mai 100.8g', 5, 38, 2995, 21400, 'Gói', 19260, 'images/sp/41.png', 'images/sp/41-big.png', NULL),
...
(62, 'Bia Tiger thùng 24 lon x 330ml', 7, 44, 2999, 374500, 'Thùng', 337050, 'images/sp/62.png', 'images/sp/62-big.png', NULL),
...
(71, 'Mì Hảo Hảo tôm chua cay 30gói x 75g', 8, 1, 2999, 126000, 'Thùng', 113400, 'images/sp/71.png', 'images/sp/71-big.png', NULL),
...
(82, 'Sữa Nan Optipro 1 HMO 900g  F', 9, 36, 2999, 486500, 'Lon', 437850, 'images/sp/82.png', 'images/sp/82-big.png', NULL),
...
--
-- Table structure for table `yeucaudoitra`
--
...
--
-- Dumping data for table `yeucaudoitra`
--
...
--
-- Indexes for table `yeucaudoitra`
--
...
--
ALTER TABLE `donhang`
  MODIFY `donhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `khachhang`
  MODIFY `khachhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT for table `yeucaudoitra`
--
ALTER TABLE `yeucaudoitra`
...
--
-- Constraints for table `yeucaudoitra`
--
ALTER TABLE `yeucaudoitra`
