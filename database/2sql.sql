...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 03, 2023 lúc 11:42 AM
...
(1, 1, NULL, '2023-06-01', NULL, 349040, '', 1, '034558864', NULL, NULL, NULL, 'HM');
...
--
ALTER TABLE `donhang`
  MODIFY `donhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
